...
| `deploymentId` | A value used as an unique identifier of the deployment for the current PR. It is used in the surge URL and to identify PR comments created by this action. | `job.name`                                                                                                                               |
